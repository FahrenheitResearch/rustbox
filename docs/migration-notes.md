...
- Archive smoke-test path:
  ...
  - fetches a real remote HRRR pressure subset, stages a rebased local GRIB fragment, and writes a decoded bundle summary manifest under `target/archive-smoke/decoded/`
